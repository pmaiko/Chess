...
import { COLOR, FIGURE, GRID_SIZE } from '~/constants/constants.ts'
import type { MoveInterface, MovesByDirection, PositionInterface } from '~/features/game/services/PositionService.ts'
