import { COLOR, GRID_SIZE, INITIAL_FIGURE_POSITIONS } from '~/constants/constants.ts'
import { PositionService } from '~/features/game/services/PositionService.ts'
import Cell from '~/features/game/entities/Cell.ts'
import { FigureFactory } from '~/features/game/factories/FigureFactory.ts'
